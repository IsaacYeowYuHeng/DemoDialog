package sg.edu.rp.c346.id22021538.demodialog;
        ...
        btnDemo4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        String input2Str = etInput2.getText().toString();
                        String input3Str = etInput3.getText().toString();
                        // Set the text to the TextView
                        ...
                        tvDemo4.setText(String.valueOf(sum));
                    }
                });
                myBuilder.setNegativeButton("CANCEL", null);
                AlertDialog myDialog = myBuilder.create();
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog.OnTimeSetListener myTimeListener = new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int currentHour, int currentMinute) {
                        tvDemo6.setText("Time: " + currentHour + ":" + currentMinute);
                    }
                };
